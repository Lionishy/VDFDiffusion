...
namespace iki { namespace diffusion { 
	template <typename T>
	struct SimpleTwoDimensionalSolver final : TwoDimensionalSolver<T> {

		SimpleTwoDimensionalSolver(size_t x_size, size_t y_size, T rx, T ry, std::vector<T> const &f, std::vector<T> const &x_dfc_host, std::vector<T> const &y_dfc_host, std::vector<T> const &xy_dfc_host, std::vector<T> const &yx_dfc_host): TwoDimensionalSolver<T>(x_size, y_size, rx, ry, f, x_dfc_host, y_dfc_host, xy_dfc_host, yx_dfc_host) { }
