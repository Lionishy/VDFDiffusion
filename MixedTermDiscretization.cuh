...
namespace iki {	namespace diffusion { namespace device {
	template <typename T> inline
		...
		return T(0.25) * (xy_dfc_right * (Fijp1 - Fijm1) + xy_dfc_right * (Fip1jp1 - Fip1jm1) + xy_dfc_left * (Fijm1 - Fijp1) + xy_dfc_left * (Fim1jm1 - Fim1jp1));
	}
	...
	template <> inline
		...
		return 0.25f * (__fmaf_rn(xy_dfc_right, Fijp1, -xy_dfc_right * Fijm1) + __fmaf_rn(xy_dfc_right, Fip1jp1, -xy_dfc_right * Fip1jm1) + __fmaf_rn(xy_dfc_left, Fijm1, -xy_dfc_left * Fijp1) + __fmaf_rn(xy_dfc_left, Fim1jm1, -xy_dfc_left * Fim1jp1));
	}
} /* device */	} /* math */ } /* iki */
